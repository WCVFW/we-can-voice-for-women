  ...
  return (
    <footer className="bg-pink-600 text-white font-inter">
      <div className="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-[1.5fr_repeat(3,1fr)] gap-8">
          ...
          <div>
            ...
            <div className="flex gap-3">
              <a href="https://www.facebook.com/wecanvoiceforwomen/" target="_blank" rel="noopener noreferrer"><Facebook size={20} /></a>
              <a href="https://x.com/wcvfwf" target="_blank" rel="noopener noreferrer"><Twitter size={20} /></a>
              <a href="https://www.instagram.com/wecanvoiceforwomen/" target="_blank" rel="noopener noreferrer"><Instagram size={20} /></a>
              <a href="https://www.youtube.com/@WeCanVoiceforWomen" target="_blank" rel="noopener noreferrer"><Youtube size={20} /></a>
              <a href="https://www.linkedin.com/company/voiceforwomen/?viewAsMember=true" target="_blank" rel="noopener noreferrer"><Linkedin size={20} /></a>
            </div>
          </div>
          ...
          {/* Column 3: What We Do */}
          <div>
            <h3 className="text-xl font-semibold mb-3 border-b border-white/30 pb-2">What We Do</h3>
            <ul className="space-y-2 text-sm">
              {[
          ...
          <div>
            <h3 className="text-xl font-semibold mb-3 border-b border-white/30 pb-2">Contact Us</h3>
